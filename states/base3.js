...
techtip.base3 = function (game) {
}

techtip.base3.prototype = {
    ...
    create: function () {
        ...
        this.tilemap = game.add.tilemap('level4', 16, 16, 800, 600);
        ...
        this.phaserDude = game.add.sprite(0, 348, 'player4');
        ...
        var star = stars.create(550.00, 493.00, 'chair');
        var star = stars.create(800.00, 390.00, 'chair');
        ...
        var star = stars.create(2582.00, 700.00, 'chair');
        var star = stars.create(3061.00, 553.00, 'chair');
    ...
    update: function () {
        if (final_step == 9) {
            ...
            game.time.events.add(Phaser.Timer.SECOND * 8, function sld() {
                ...
                game.state.start('base4', true, false, 2, 3, '', 0, score, 0);
            }, this);
        }
        ...
        if (cursors.right.isDown) {
            ...
            this.phaserDude.body.velocity.x = 220;
        }
