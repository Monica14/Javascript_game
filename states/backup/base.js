...
techtip.menu.prototype = {
    ...
    preload: function () {
        ...
        game.load.spritesheet('player1', 'assets/sprites/player_demo.png', 102, 147);
        game.load.spritesheet('player2', 'assets/sprites/linda_player.png', 102, 147);
        game.load.spritesheet('player3', 'assets/sprites/max_player.png', 107, 149);
        game.load.spritesheet('player4', 'assets/sprites/oma_player.png', 102, 147);
        game.load.spritesheet('player5', 'assets/sprites/putzi_player.png', 102, 147);
        game.load.tilemap('level1', 'assets/tilemaps/maps/level1.json', null, Phaser.Tilemap.TILED_JSON);
        game.load.tilemap('level2', 'assets/tilemaps/maps/level2.json', null, Phaser.Tilemap.TILED_JSON);
        ...
        game.load.image('star', 'assets/sprites/chair.png'); ////////// add sprite
    ...
    create: function () {
        ...
        var star = stars.create(600, 280, 'star');
