...
techtip.base2 = function (game) {
}
techtip.base2.prototype = {
    ...
    create: function () {
        ...
        this.tilemap = game.add.tilemap('level3', 16, 16, 800, 600);
        ...
        this.tilemap.addTilesetImage('wolken_l3');
        ...
        this.phaserDude = game.add.sprite(0, 348, 'player3');
        ...
        var star = stars.create(400, 280, 'star');
        var star = stars.create(700, 300, 'star');
    ...
    update: function () {
        ...
        if (final_step == 9) {
            ...
            game.time.events.add(Phaser.Timer.SECOND * 8, function sld() {
                ...
                game.state.start('base3', true, false, 2, 3, '', 0, score,0);
            }, this);
        }
        ...
        if (cursors.right.isDown) {
            this.phaserDude.animations.play('walk', 5, true);
            game.physics.arcade.overlap(this.phaserDude, stars, collectStar, null, this);
            this.phaserDude.body.velocity.x = 200;
        }
